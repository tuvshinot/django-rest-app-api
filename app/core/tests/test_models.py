...
class ModelTests(TestCase):
    ...
    @patch('uuid.uuid4')  # uuid model name - func to mock
    def test_recipe_file_name_uuid(self, mock_uuid):  # mocked uuid func
        """ Test that images is saved in the correct location """
        uuid = 'test-uuid'  # mocking that uuid func return value
